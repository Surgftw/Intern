...
function LevelMaker.generate(width, height)
    ...
    local lockBoxPos = math.random(1,width)
    local KeyPos = math.random(1,width)
    local KeyCol = math.random(1, 4)
    ...
    for x = 1, width do
        ...
        if math.random(7) == 1 and x ~= 1 and lockBoxPos ~= x and KeyPos ~= x then
            for y = 7, height do
                table.insert(tiles[y],
                    Tile(x, y, tileID, nil, tileset, topperset))
            end
                        ...
                        if keyCollected then
                            ...
                            local flagpost = GameObject{
                                ...
                                onConsume = function(player, object)
                                    ...
                                    gStateMachine:change('play', { score = player.score, lastLevelWitdh = width })
                                end
