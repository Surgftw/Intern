...
gTextures = {
    ...
    ['kal'] = love.graphics.newImage('graphics/keys_and_locks.png'),
    ['flag'] = love.graphics.newImage('graphics/flag.png'),
    ['post'] = love.graphics.newImage('graphics/poles.png')
}
...
gFrames = {
    ...
    ['kal'] = GenerateQuads(gTextures['kal'], 16, 16),
    ...
    ['flag'] = GenerateQuads(gTextures['flag'], 16, 10),
    ['post'] = GenerateQuads(gTextures['post'], 8, 48)
}
